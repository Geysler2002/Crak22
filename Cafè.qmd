...
Paso Nª1: Obtenciòn de las imagenes 
...
Paso Nª2: Establecimiento de una escala 
...
Paso Nª3: adjunto de las imagesnes 

Se subieron a una pagina de Google Drive 60 imagenes de fotografías de hojas de coffee (cafè) junto con una moneda de un “Nuevo sol” como referencia de escala. Las imágenes fueron tomadas en condiciones controladas para asegurar consistencia en iluminación y tamaño.

![Imagenes cargadas al Google Drive de las hojas de cafè](C:\Users\geysl\Documents\Cafè\23.jpg)
...
Paso Nª5: Ejecucion de Label Stdio 
...
![](C:\Users\geysl\Documents\Cafè\8.jpg)
![Codigos para la ejecucion de Anaconda](C:\Users\geysl\Documents\Cafè\6.jpg)

Paso Nª6: creaciòn de una cuenta de usiario Al ejecutar los codigos de Label Studio, la aplicaciòn nos direge a crear una pagina de registro el cual llenamos como dicta sus caracteristicas . 

![Llemar con los cuadros en blanco](C:\Users\geysl\Documents\Cafè\0.1.jpg)

Paso Nª7: Creaciòn de un nuevo proyecto Al registrate en la pagina generamos un proyecto en la cual llenaremos datos sugueridos por la aplicacion y realizamos ajuates para nuestro beneficio. 

![](C:\Users\geysl\Documents\Cafè\9.jpg)

Luego nos dirigimos Labeling Setup, para seleccionar la opciòn de poligonos en la textura de imagen, la cual se divide en la correcion de dos palabras (lamina y moneda). 

![](C:\Users\geysl\Documents\Cafè\10.jpg)

Al final nos dirigimos Data Import para exportar todas las imagenes de Google Drive para su analisis. 

![](C:\Users\geysl\Documents\Cafè\14.jpg)

Paso Nª8: Anotaciòn de las imagenes En este procedimiento se realizo la separaciòn de la lamina de hoja de cafè y la moneda de un "Nuevo sol", utilizando puntos referenciales para la separaciòn de estos dos objetos.

![](C:\Users\geysl\Documents\Cafè\11.jpg)
